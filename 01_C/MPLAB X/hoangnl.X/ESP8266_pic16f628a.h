...
void ESP8266_Init(void)
{
    ...
    TRISRB1 = 1; // TX Pin set as output
    TRISRB2 = 1; // RX Pin set as input
...
//________UART module Initialized__________//
 void ESP8266_Init(const long int baudrate)
{
    unsigned int x = (_XTAL_FREQ/(baudrate*64)) - 1;
    //****Setting I/O pins for UART****//
    TRISB1 = 1; // TX Pin set as datasheet
    TRISB2 = 1; // RX Pin set as datasheet
    //________I/O pins set __________//
