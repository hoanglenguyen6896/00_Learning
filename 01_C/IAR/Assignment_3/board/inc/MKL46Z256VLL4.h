...
#define CLKA_SHIFT                      (9u)
#define CLOCKA_ENABLE                   (CLK_SET << CLKA_SHIFT)
/* Enable Clock for GPIOB */
#define CLKB_SHIFT                      (10u)
#define CLOCKB_ENABLE                   (CLK_SET << CLKB_SHIFT)
/* Enable Clock for GPIOC */
#define CLKC_SHIFT                      (11u)
#define CLOCKC_ENABLE                   (CLK_SET << CLKC_SHIFT)
/* Enable Clock for GPIOD */
#define CLKD_SHIFT                      (12u)
#define CLOCKD_ENABLE                   (CLK_SET << CLKD_SHIFT)
/* Enable Clock for GPIOE */
#define CLKE_SHIFT                      (13u)
#define CLOCKE_ENABLE                   (CLK_SET << CLKE_SHIFT)
