...
#define FTFA_ADDR           (0x40020000u)   /* Define FTFA base address */
...
#define UART0_ADDR          (0x4006A000u)   /* Define UART0 base address */

#define NVIC_ADDR           (0xE000E100u)   /* Define NVIC base address */
