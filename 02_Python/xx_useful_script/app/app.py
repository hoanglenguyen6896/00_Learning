...
def bot_live_update():
    ...
    while True:
        ...
        try:
            r = requests.get('https://wes-agv-portal-gateway.iherbscs.net/api/Fleet/liveUpdates')
        except:
            os.system('cls')
            connect_err += 1
        ...
        bot_live_json = r.json() # Return a dictionary
        ...
        try:
            resp = requests.get('https://wes-agv-portal-gateway.iherbscs.net/api/bots/connected')
        except:
            os.system('cls')
            connect_err += 1
        ...
        # Show ignore
        print(connection_dict_old.items())
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if ord(key) == ord('c'):
            ...
            while bot_live_pause == False and bot_connection_pause == False:
                time.sleep(1)
