    ...
    if fw == False:
        with SCPClient(ssh.get_transport()) as scp:
            try:
                ...
                scp.get(sv_log_dir + "agv_x2_fw" + log_tail[10], cli_log_dir)
            except Exception as e:
                print("End old")
                print(Fore.RED + str(e))
                ssh.close()
        ...
        with SCPClient(ssh.get_transport()) as scp:
            try:
                for line in log_tail:
                    scp.get(sv_log_dir + "agv_x2_executive" + line, cli_log_dir)
                ...
                # scp.get(sv_log_dir + "agv_x2_executive" + log_tail[10], cli_log_dir)
            except Exception as e:
                print("End new")
                print(Fore.RED + str(e))
                ssh.close()
